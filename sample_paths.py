...
if __name__ == '__main__':
    ...
    for _ in range(50):
        ...
        Y_c = generating_kernel_paths(kernel=custom_kernel, RKHS_norm=1, iterations_begin=iterations_begin,
                                      iterations_end=iterations_end, num_X_center_min=400, num_X_center_max=800, X_plot=X_plot, ell=1e-16)
        list_Y.append(Y_c)
    plt.figure()
    for Y_c in list_Y:
    ...
    # Plot kernel
    K, a = custom_kernel(X_plot, X_plot, ell=1)
